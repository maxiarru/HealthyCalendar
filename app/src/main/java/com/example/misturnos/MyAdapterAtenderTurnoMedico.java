...
public class MyAdapterAtenderTurnoMedico extends BaseAdapter {
    ...
    public MyAdapterAtenderTurnoMedico(Context context, int layout, List<Turno> turnos){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        v = layoutInflater.inflate(R.layout.cuadro_medico_atender, null);
        // nos traemos el vlor actual dependiendo de la pos.i
        Turno turnoActual = turnos.get(position);
        // referenciamos el elemento a modificar y lo rellenamos
        TextView textView = (TextView) v.findViewById(R.id.txtnroTurnoatender);
        ...
        TextView textFecha = (TextView) v.findViewById(R.id.txtFechaatender);
        ...
        agendar = (Button) v.findViewById(R.id.cbAtender);
        agendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<Void> call = service.putAtenderTurnoMedico(idPatient, turnoActual.getId());
